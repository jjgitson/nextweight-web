    ...
    <div className="w-full h-[240px] md:h-[320px] bg-white relative">
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={chartData} margin={{ top: 20, right: 70, left: 10, bottom: 10 }}>
          ...
          <Line type="monotone" dataKey="mounjaro" stroke="#94a3b8" strokeDasharray="4 4" dot={false} label={<CustomizedLabel labelText="터제타파이드" data={chartData} />} />
          <Line type="monotone" dataKey="wegovy" stroke="#cbd5e1" strokeDasharray="4 4" dot={false} label={<CustomizedLabel labelText="위고비" data={chartData} />} />
